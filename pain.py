...
window_icon = pygame.image.load("snack.png")
...
# create background
background_img = pygame.image.load("bvar3.png")  # 800 x 600 px image
background_music_paths = ["backmusic.wav"]
...
def init_game():
    ...
    # player
    player_img_path = "doge.png"  # 64 x 64 px image
    player_width = 64
    player_height = 64
    ...
    player_dy = 0
    player_kill_sound_path = "bark.wav"
    ...
    # bullet
    bullet_img_path = "bullet2.png"  # 32 x 32 px image
    bullet_width = 32
    bullet_height = 32
    ...
    relaxation_time = 100
    laser_beam_sound_path = "meow.wav"
...
class Starting:  # init game
    def __init__(self):
        self.game = init_game()
        self.music = init_background_music()
        self.runned_once = False

    def starting(self):
        global running, pause_state, RIGHT_ARROW_KEY_PRESSED, LEFT_ARROW_KEY_PRESSED, SPACE_BAR_PRESSED
        global UP_ARROW_KEY_PRESSED, frame_count, total_time, fps
